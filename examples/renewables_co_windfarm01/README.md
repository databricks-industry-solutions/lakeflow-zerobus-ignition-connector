### Renewables Co windfarm simulation (Ignition) — example
...
- **`renewables_co_windfarm01_tags.json`**: Ignition Tag Browser JSON export you can import into a tag provider.
...
- Right-click → **Import**
- Choose **JSON**
- Import `examples/renewables_co_windfarm01/renewables_co_windfarm01_tags.json`
...
- Set:
  ...
  - **Delay (ms)**: 1000
  - **Enabled**: true
- Paste the contents of `examples/renewables_co_windfarm01/timer_script_windfarm01.py` into the Timer script editor.
